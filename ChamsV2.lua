...
local ChamsgV2 = Instance.new("ScreenGui")ChamsgV2.Name = "ChamsV2" ChamsgV2.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui") ChamsgV2.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

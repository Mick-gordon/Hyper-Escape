...
-- Nice and clean
local AimbotV2 = Instance.new("ScreenGui")AimbotV2.Name = "AimbotV2" AimbotV2.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui") AimbotV2.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

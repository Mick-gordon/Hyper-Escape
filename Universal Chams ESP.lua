...
local OutlinesV3 = Instance.new("ScreenGui")OutlinesV3.Name = "OutlinesV3" OutlinesV3.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui") OutlinesV3.ZIndexBehavior = Enum.ZIndexBehavior.Sibling OutlinesV3.ResetOnSpawn = false

local HitboxV2 = Instance.new("ScreenGui")HitboxV2.Name = "HitboxV2" HitboxV2.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui") HitboxV2.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
